...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static String POST(String url, Person person){
        ...
        try {
            ...
            jsonObject.accumulate("date", person.getDate());
        ...
        switch(view.getId()){
            case R.id.btnPost:
                if(!validate())
                    ...
                    httpTask.execute("http://192.168.35.226:8080/arduino", etName.getText().toString(), etCountry.getText().toString(), etTwitter.getText().toString());
                }
                break;
        }
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            person = new Person();
            person.setToken(urls[1]);
            person.setDate(urls[2]);
